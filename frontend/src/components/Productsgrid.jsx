...
text-xl font-semibold'>Featured Bicycles!</h1>
      <h1 data-aos="zoom-in" data-aos-delay="200" className='text-black font-semibold text-[42px] leading-[50px] text-center'>Just Book Man!</h1>
      <div data-aos="zoom-in" data-aos-delay="300" className='w-full grid
lg:grid-cols-4 grid-cols-1 justify-center items-center gap-10 mt-5'>
        {
          products.map((item, index) =>
            <div id="product-box" key={index} className="flex flex-col hover:scale-[1.05] transition-all duration-300 justify-center items-center gap-2 bg-white p-4 rounded-lg cursor-pointer relative">
              <img src={item.img} alt="" className='w-[300px] h-[280px] rounded-lg' />
              ...
              <div className='flex justify-between items-center gap-6 mt-3'> 
               ...
               <button className='bg-green-500 text-white px-4 py-2 rounded-lg text-[13px] font-semibold'  onClick={handleBookNowClick}>BOOK NOW</button>
          </div >
        </div >
         </div >)
        }
